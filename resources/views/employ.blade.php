                ...
                <div class="dropdown">
                    <div class="user col align-self-end">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                            ...
                            <!-- <a class="dropdown-item" href="/admin/work">Công Việc</a> -->
        ...
        <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true" style="background: rgb(7, 71, 166);color: white;">
                <ul class="navigation-left">
                    <!-- <li class="nav-item"><a class="nav-item-hold" href="/admin"><i class="nav-icon i-File-Horizontal-Text"></i><span class="nav-text">Quản lý nhân viên</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" data-item="phanquyen"><a class="nav-item-hold" href="#"><i class="nav-icon i-Library"></i><span class="nav-text">Quản lý tiêu chí</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item"><a class="nav-item-hold" href="/admin/department"><i class="nav-icon i-ID-Card"></i><span class="nav-text">Quản lý điểm số</span></a>
                        <div class="triangle"></div>
                    </li> -->
                </ul>
            </div>
